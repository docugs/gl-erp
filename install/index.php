...
page(_('Installation Wizard'), true, false, '', '', false, 'stylesheet.css');
...
switch(@$_POST['Page']) {
	...
	case '2':
		...
		check_row(_('Install Additional Language Packs from ERP Repository:'), 'sel_langs');
		check_row(_('Install Additional COAs from ERP Repository:'), 'sel_coas');
		end_table(1);
	...
	case '5':
		...
		break;
	case '6': // final screen
		subpage_title(_('ERP has been installed successsfully.'));
