...
*/
    ...
    // Powered by
    $power_by       = 'RAD IT SOLUTIONS';
    $power_url      = 'http://rad-it.com';
...
/*  
    ...
    this setting is depreciated and subject to removal in next versions
*/
    $old_style_help = 0; 
    //  locally installed wiki module
    //  $help_base_url = $path_to_root.'/modules/wiki/index.php?n='._('Help').'.';
    //  context help feed from rad-it.com
    //  set to null if not used:
    //  $help_base_url = null;
    $help_base_url = 'http://support.rad-it.com/ERP/index.php?n=Help.';
...
/*
    Date systems:
    0 = traditional,
    1 = Jalali used by Iran, Afghanistan and some other Central Asian nations,
...
*/
    ...
    // UTF-8 font for Business Graphics. Copy font files to /reporting/fonts/ folder.
    $UTF8_fontfile = isset($_SESSION['language']) && $_SESSION['language']->dir == 'rtl' ? "zarnormal.ttf" : "FreeSans.ttf";
...
/*  
    Hide menu items (Applications, Modules, and Actions) from the user if they don't have access to them.
*/
